...
export RK_PARTITION_CMD_IN_ENV="256K(env),256K@256K(idblock),512K(uboot),256K(verify),256K(fdt),6M(boot),30M(oem),10M(userdata),80M(rootfs)"
...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rv1106_quick_defconfig
